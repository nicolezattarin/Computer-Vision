...
\begin{table}\centering
  ...
  & dp & 1 \\
   ...
   & maxRadius & 32 \\ \hline
  \end{tabular}
  \caption{Parameters set for road3.jpg image, for all the three algorithms.} \label{tab:r3}
  \end{table}
...
Results for \codeword{road4.jpg} are shown in Table \ref{tab:r4} and Figure \ref{fig:road4}, in this case we identify both the limiting line of the road and two lines inside of the street itself. We then fill the two roadways with different colors, in order to highlight the line in the middle, moreover we detect circles corresponding to signals.
...
\begin{table}\centering
  ...
  & dp & 1 \\
   ...
   & maxRadius & 14 \\ \hline
  \end{tabular}
  \caption{Parameters set for road4.jpg image, for all the three algorithms.} \label{tab:r4}
  \end{table}
